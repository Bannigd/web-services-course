...
1. Следуя инструкции в пункте [2. Регистрация приложения](https://vk.com/dev/first_guide?f=2.%20%D0%A0%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8F%20%D0%BF%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F) зарегистрируйте новое приложение, указав в названии «Изучение API» (или что-то в этом роде).
...
```
   ...
   1. Как отфильтровать документы по типу? Как ограничить количество документов в выдаваемой  выборке?  Опишите схему загрузки документов. Подсказка: для загрузки необходимо использовать два  метода и один POST запрос на специальный адрес.
